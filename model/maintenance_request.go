...
func (o *Maintenance_request) Save() error {
	if res, err := DB.NamedExec(`INSERT INTO maintenance_request(id,request_date,type,status,cost,invoice_id,contract_id ) VALUES(:id,:request_date,:type,:status,:cost,:invoice_id,:contract_id)`, o); err != nil {
		return err
	} else {
