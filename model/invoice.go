...
func (o *Invoice) Save() error {
	if res, err := DB.NamedExec(`INSERT INTO invoice(id,date,description,amount,number,issuer,to,property_id,due_date ) VALUES(:id,:date,:description,:amount,:number,:issuer,:to,:property_id,:due_date)`, o); err != nil {
		return err
	} else {
