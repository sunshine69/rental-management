...
func (o *Payment) Save() error {
	if res, err := DB.NamedExec(`INSERT INTO payment(id,account_id,amount,pay_date,contract_id,reference ) VALUES(:id,:account_id,:amount,:pay_date,:contract_id,:reference)`, o); err != nil {
		return err
	} else {
