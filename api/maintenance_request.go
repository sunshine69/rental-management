...
func CreateMaintenance_request(w http.ResponseWriter, r *http.Request) {
	if maintenance_request := u.ParseJsonReqBodyToStruct[model.Maintenance_request](r); maintenance_request != nil {
...
func DeleteMaintenance_request(w http.ResponseWriter, r *http.Request) {
	if id := utils.ParseID(r); id != 0 {
		...
		maintenance_request := u.ParseJsonReqBodyToStruct[model.Maintenance_request](r)
